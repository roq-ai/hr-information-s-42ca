...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getEmployees({
        ...
        order: params.order,
        searchTermKeys: ['first_name.contains', 'last_name.contains', 'payroll_information.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'vacation_balance', header: 'vacation_balance', accessorKey: 'vacation_balance' },
    ...
    hasAccess('vacation_request', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'vacation_request',
          header: 'Vacation Request',
          accessorKey: 'vacation_request',
          cell: ({ row: { original: record } }: any) => record?._count?.vacation_request,
        }
      : null,
