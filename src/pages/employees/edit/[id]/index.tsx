      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'vacation_balance',
              isInvalid: !!formik.errors?.vacation_balance,
            }}
            name="vacation_balance"
            error={formik.errors?.vacation_balance}
            value={formik.values?.vacation_balance}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('vacation_balance', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
